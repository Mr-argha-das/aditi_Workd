...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1254 1254" width="1254" height="1254" fill="none">
  <defs>
    ...
    <!-- Professional Dropshadow Filters -->
    <filter id="ribbonShadow" x="-20%" y="-20%" width="150%" height="150%">
      <feDropShadow dx="-6" dy="12" stdDeviation="14" flood-color="#020412" flood-opacity="0.9"/>
    </filter>

    <filter id="shaftShadow" x="-30%" y="-30%" width="160%" height="160%">
      <feDropShadow dx="-10" dy="10" stdDeviation="16" flood-color="#010210" flood-opacity="0.95"/>
    </filter>
    ...
    <filter id="whiteGlow" x="-20%" y="-20%" width="140%" height="140%">
      <feDropShadow dx="0" dy="2" stdDeviation="6" flood-color="#ffffff" flood-opacity="0.22"/>
    </filter>
    ...
    <!-- 4. Left Arch Front Face (Cyan to Royal Blue) -->
    ...
    <!-- 6. Ascending Arrow Shaft (Blue to Indigo to Violet) -->
    ...
    <!-- 9. Right Pillar (Royal to Vibrant Purple) -->
  ...
  <!-- ==================== ICON MARK ==================== -->
  <g id="icon-mark">
    <!-- 1. Lower Left Growth Bar 1 (Shortest: width 40, height 72) -->
    <rect x="424" y="588" width="40" height="72" rx="18" fill="url(#bar1Grad)"/>

    <!-- 2. Lower Left Growth Bar 2 (Middle: width 40, height 104) -->
    <rect x="481" y="556" width="40" height="104" rx="18" fill="url(#bar2Grad)"/>

    <!-- 3. Lower Left Growth Bar 3 (Tallest: width 40, height 140) -->
    <rect x="538" y="520" width="40" height="140" rx="18" fill="url(#bar3Grad)"/>
    ...
    <!-- Outer edge goes straight up from (424, 567) to (424, 400), curves over top shoulder, slopes to (535, 365) -->
    <!-- Inner edge heads from (529, 463) down-left to (424, 567) -->
    <path d="M 424 567
             L 424 400
             C 424 365 455 347 495 347
             C 512 347 525 354 535 365
             L 529 463
             L 424 567
             Z"
    ...
    <!-- Shaft width ~78px, rising at ~45° from valley (666, 573) to notch (806, 404) -->
    <path d="M 605 522
    ...
    <!-- 8. Center V-Turn Crease / High-tech 3D fold highlight -->
    <path d="M 605 522
    ...
    <line x1="806" y1="404" x2="864" y2="309" stroke="#ffffff" stroke-width="2.5" stroke-linecap="round" opacity="0.7"/>
  </g>
  ...
  <g id="typography">
    ...
    <text x="182" y="818" class="brand-title" fill="#ffffff" filter="url(#whiteGlow)">Index</text>
...
fs.writeFileSync('/tmp/logo_v3.svg', svg);
fs.writeFileSync('/home/hj/Desktop/adii/logo.svg', svg);
console.log('Saved /tmp/logo_v3.svg and /home/hj/Desktop/adii/logo.svg');
